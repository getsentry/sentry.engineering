...
images: [../../assets/images/js-mutation-testing-our-sdks/hero.jpg]
...
Does this translate to other code bases? It's hard to say give a definitive answer, but it seems reasonable for most code bases. For the sake of experimenting, we decided to go ahead with a "yes".
...
![Core SDK package mutation test results](../../assets/images/js-mutation-testing-our-sdks/mt-result-core.png)
...
![Mutation scores of all packages](../../assets/images/js-mutation-testing-our-sdks/mt-results-all.png)
...
![Performance Trace Waterfall of an entire mutation test run](../../assets/images/js-mutation-testing-our-sdks/mt-trace.png)
...
![Mutation testing CI Setup](../../assets/images/js-mutation-testing-our-sdks/ci-setup.png)
