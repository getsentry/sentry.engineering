...
images: ["../../assets/images/mobile-app-launch-profiling/launch-profile.png"]
...
![A flamechart showing an example launch profile, with work on the main thread before the actual call to `main()`.](../../assets/images/mobile-app-launch-profiling/launch-profile.png)
