...
![The $3M dropdown in the Sentry organization creation flow that sets where your customer data is stored](../../assets/images/3m-dollar-dropdown/create-org.png)
...
![An organization picker from sentry.io](../../assets/images/3m-dollar-dropdown/orgpicker.png)
...
![650k lines of code, 30k tests, 660 endpoints, 480 models](../../assets/images/3m-dollar-dropdown/stats.png)
...
![Depiction of domain areas within the monolith](../../assets/images/3m-dollar-dropdown/domains.png)
...
![A sequence diagram illustrating the oauth proxy refreshing tokens for all requests across clusters](../../assets/images/3m-dollar-dropdown/oauth-proxy.png)
