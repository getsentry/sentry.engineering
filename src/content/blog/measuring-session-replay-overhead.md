...
images: ["../../assets/images/measuring-session-replay-overhead/hero.jpg"]
...
![Terminal output showing measurments](../../assets/images/measuring-session-replay-overhead/overhead-output.png)
...
![Example image of Playwright Inspector from Playwright docs](../../assets/images/measuring-session-replay-overhead/playwright-inspector.png)
...
![In the Playwright Inspector window, change “Target” from Node.js “Test Runner” to “Library”](../../assets/images/measuring-session-replay-overhead/playwright-inspector-change-target.png)
...
![Code snippet that should be copied](../../assets/images/measuring-session-replay-overhead/generated-code-to-copy.png)
...
![Terminal output for multiple scenarios](../../assets/images/measuring-session-replay-overhead/multiple-scenarios-output.png)
