...
![A screenshot of a fully formatted SQL query with indentation and whitespace](../../assets/images/formatting-sql-on-the-frontend/full-query.png)
...
![A screenshot of a list of SQL queries where the keywords are slightly bolder than the other text](../../assets/images/formatting-sql-on-the-frontend/query-list.png)
...
![Five line charts showing the duration of query formatting at the 50th, 75th, 95th, and 99th percentiles. The values are roughly 0ms, 1ms, 2ms, and 6ms respectively](../../assets/images/formatting-sql-on-the-frontend/perf.png)
