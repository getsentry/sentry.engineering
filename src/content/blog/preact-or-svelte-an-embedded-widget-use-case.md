...
images: [../../assets/images/preact-or-svelte-an-embedded-widget-use-case/hero.jpg]
...
![Basic dialog and form for the user feedback widget](../../assets/images/preact-or-svelte-an-embedded-widget-use-case/user-feedback-form.png)
...
![Build size of Preact implemetation](../../assets/images/preact-or-svelte-an-embedded-widget-use-case/preact-build.png)
...
![Build size of Svelte implemetation](../../assets/images/preact-or-svelte-an-embedded-widget-use-case/svelte-build.png)
...
![Bundle size visualizer for Preact build](../../assets/images/preact-or-svelte-an-embedded-widget-use-case/preact-build-analyzer.png)

_Vite bundle visualizer for the Preact build — almost half the build is just the framework_

![Bundle size visualizer for Svelte build](../../assets/images/preact-or-svelte-an-embedded-widget-use-case/svelte-build-analyzer.png)
...
![User feedback widget with screenshotting and cropping capabilities](../../assets/images/preact-or-svelte-an-embedded-widget-use-case/user-feedback-screenshot-crop.png)
