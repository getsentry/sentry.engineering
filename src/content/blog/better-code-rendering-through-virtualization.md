...
![@andhaveaniceday reaching out via X](../../assets/images/better-code-rendering-through-virtualization/user-reaching-out-via-x.png)
...
![Video of the page crashing the browser while attempting to render](../../assets/images/better-code-rendering-through-virtualization/old-renderer-crashing.gif)
...
![Zoomed out flame graph of the code renderer](../../assets/images/better-code-rendering-through-virtualization/understanding-root-cause-flamegraph-1.png)
...
![Zoomed in flame graph of the focusing on the tokenizing](../../assets/images/better-code-rendering-through-virtualization/understanding-root-cause-flamegraph-2.png)
...
![Zoomed in flame graph of the focusing on the React rendering](../../assets/images/better-code-rendering-through-virtualization/understanding-root-cause-flamegraph-3.png)
...
![Math equation for calculating the average render time per line](../../assets/images/better-code-rendering-through-virtualization/equation-1.png)

Entering our values from our example, we get the following equation:

![Math equation for calculating the total render time, with the values passed in, equalling 0.897ms](../../assets/images/better-code-rendering-through-virtualization/equation-2.png)
...
![Multiplying the average render time per line by the total number of lines, equalling 46.90s](../../assets/images/better-code-rendering-through-virtualization/equation-3.png)
...
![Unstyled code renderer utilizing virtualization](../../assets/images/better-code-rendering-through-virtualization/unstyled-code-renderer.png)
...
![Styled code renderer utilizing virtualization](../../assets/images/better-code-rendering-through-virtualization/styled-code-renderer.png)
...
![Blue textarea animating over the tokenized content, highlighting how the textarea is overlayed](../../assets/images/better-code-rendering-through-virtualization/text-overlay.gif)
...
![List of file extensions and their frequency](../../assets/images/better-code-rendering-through-virtualization/sentry-tag-details.png)
...
![Bar graph of the frequency of each file extension issue being created, decreasing overtime](../../assets/images/better-code-rendering-through-virtualization/sentry-issues-values.png)
...
![Flame graph of the virtual code renderer with pointer events enabled while scrolling, highlighting the forced reflows](../../assets/images/better-code-rendering-through-virtualization/pointer-events-flame-graph-1.png)
...
![Flame graph of the virtual code renderer with pointer events disabled while scrolling, no forced reflows](../../assets/images/better-code-rendering-through-virtualization/pointer-events-flame-graph-2.png)
...
![Browser dev tools highlighting last element being obscured by horizontal scrollbar](../../assets/images/better-code-rendering-through-virtualization/custom-scrollbars-1.png)
...
![Browser dev tools highlighting how GitHub creates their custom scrollbar](../../assets/images/better-code-rendering-through-virtualization/custom-scrollbars-2.png)
...
![Browser dev tools highlighting how our custom scrollbar is added](../../assets/images/better-code-rendering-through-virtualization/custom-scrollbars-3.png)
...
![Gif of the before and after of our code renderers, rendering checker.ts](../../assets/images/better-code-rendering-through-virtualization/code-renderers-synced-up.gif)
...
![@andhaveaniceday responding via X to our new renderer](../../assets/images/better-code-rendering-through-virtualization/user-responding-via-x.png)
