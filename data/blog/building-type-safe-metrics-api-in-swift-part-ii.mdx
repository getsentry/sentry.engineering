...
![Hero image showing the final Metrics API code](/images/building-type-safe-metrics-api-in-swift/hero.png)
...
![Compiler error when multiple conformances to same protocol](/images/building-type-safe-metrics-api-in-swift/multi-conformance.png)
...
![Swift 5 warning for unknown cases](/images/building-type-safe-metrics-api-in-swift/switch-unknown-values-swift-5.png)
